...
namespace IIS.Product_19312
{
    ...
    public partial class ClassE : BaseEditForm<Subject>
    {
        ...
        /// Конструктор формы
        /// </summary>
        public ClassE() : base("Sec_SubjectE")
        {
...
//            wolvUserRoles.SkipDataLoad = true;
        ...
        private void GenerateClassesTable(List<Permissions> permissions, Table tbl)
        {
